...
$meta_boxes[] = array(
    'id' => 'template-home20',
    'title' => __('Featured Blocks Area2', 'framework'),
    'pages' => array('page'),
    'show' => array(
    // With all conditions below, use this logical operator to combine them. Default is 'OR'. Case insensitive. Optional.
    'relation' => 'OR',
    ...
    'fields' => array(
        array(
            'name' => __('Switch for featured blocks2', 'framework'),
            'id' => $prefix . 'imic_featured_blocks2',
            'desc' => __("Select enable or disable to show/hide featured blocks.", 'framework'),
            'type' => 'select',
            'options' => array(
                '1' => __('Enable', 'framework'),
        ...
        array(
            'name' => __('Featured Blocks to show on home page2', 'framework'),
            'id' => $prefix . 'home_featured_blocks2',
            'desc' => __("Enter the Posts/Pages comma separated ID to show featured blocks on Home page. example - 1,2,3", 'framework'),
            'type' => 'text',
            'std' => ''
        ...
        array(
            'name' => __('Title for featured blocks2', 'framework'),
            'id' => $prefix . 'home_row_featured_blocks2',
            'desc' => __("Enter the title for featured blocks. Add more as per the entered page IDs", 'framework'),
            'type' => 'text',
            'clone' => true,
            'std' => ''
        ...
        array(
            'name' => __('Title for first featured block2', 'framework'),
            'id' => $prefix . 'home_featured_blocks12',
            'desc' => __("Enter the title for first featured block area", 'framework'),
            'type' => 'hidden',
            'std' => ''
        ),
         array(
            'name' => __('Title for second featured block2', 'framework'),
            'id' => $prefix . 'home_featured_blocks22',
            'desc' => __("Enter the title for second featured block area", 'framework'),
            'type' => 'hidden',
            'std' => ''
        ),
         array(
            'name' => __('Title for third featured block2', 'framework'),
            'id' => $prefix .'home_featured_blocks23',
            'desc' => __("Enter the title for third featured block area", 'framework'),
            'type' => 'hidden',
            'std' => ''
        ),
